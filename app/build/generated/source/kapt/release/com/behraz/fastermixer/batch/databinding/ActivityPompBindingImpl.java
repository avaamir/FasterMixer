...
public class ActivityPompBindingImpl extends ActivityPompBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btnBroken, 8);
        ...
        sViewsWithIds.put(R.id.tvMessageCount, 15);
        ...
        sViewsWithIds.put(R.id.btnRouteDest, 21);
        sViewsWithIds.put(R.id.btnRouteProject, 22);
        sViewsWithIds.put(R.id.btnRouteHome, 23);
        sViewsWithIds.put(R.id.frameGPSState, 24);
        sViewsWithIds.put(R.id.frame_internet, 25);
        sViewsWithIds.put(R.id.ivInternet, 26);
        sViewsWithIds.put(R.id.frame_gps, 27);
        sViewsWithIds.put(R.id.ivGPS, 28);
        sViewsWithIds.put(R.id.frame_voip, 29);
        sViewsWithIds.put(R.id.ivVoip, 30);
        sViewsWithIds.put(R.id.gpBtns, 31);
    }
    // views
    @NonNull
    ...
    private ActivityPompBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (androidx.constraintlayout.widget.Group) bindings[31]
